...
from transforms import Discretizer, ToTopographicMap
import torch
...
class BinaryDataset(Dataset):
    def __init__(self, dataset):
        ...
        try:
            self.dataset_name = dataset.dataset.__class__.__name__.lower().replace('dataset', '')
        except:
            self.dataset_name = dataset.__class__.__name__.lower().replace('dataset', '')
...
def prepare_dataset(
        ...
        class_type: str = 'ternary', # binary, ternary
    ...
    if feature_type == 'raw_normalized':
        ...
        deap = DEAPDataset(
            io_path=f'../processed_data/deap_raw_normalized_{overlap_name}',
            root_path='../eeg_data/deap/data_preprocessed_python',
        ...
        if class_type == 'binary':
            seed = SEEDBinaryDataset(
                io_path=f'../processed_data/seed_binary_raw_normalized_{overlap_name}',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
            ...
            seed = SEEDDataset(
                io_path=f'../processed_data/seed_raw_normalized_{overlap_name}',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
                overlap=int(overlap*200), # 0, 50, 100, 150
        ...
        dreamer = DREAMERDataset(
            io_path=f'../processed_data/dreamer_raw_normalized_{overlap_name}',
            mat_path='../eeg_data/dreamer/DREAMER.mat',
            overlap=int(overlap*128), # 0, 32, 64, 96
        ...
        deap = DEAPDataset(
            io_path=f'../processed_data/deap_de_grid_{overlap_name}',
            root_path='../eeg_data/deap/data_preprocessed_python',
            overlap=int(overlap*128), # 0, 32, 64, 96
        ...
        if class_type == 'binary':
            seed = SEEDBinaryDataset(
                io_path=f'../processed_data/seed_binary_de_grid_{overlap_name}',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
                overlap=int(overlap*200), # 0, 50, 100, 150
            ...
            seed = SEEDDataset(
                io_path=f'../processed_data/seed_de_grid_{overlap_name}',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
                overlap=int(overlap*200), # 0, 50, 100, 150
        ...
        dreamer = DREAMERDataset(
            io_path=f'../processed_data/dreamer_de_grid_{overlap_name}',
            mat_path='../eeg_data/dreamer/DREAMER.mat',
            overlap=int(overlap*128), # 0, 32, 64, 96
        ...
        deap = DEAPDataset(
            io_path='../processed_data/deap_de_interpolated_grid',
            root_path='../eeg_data/deap/data_preprocessed_python',
            
            offline_transform=transforms.Compose([
                transforms.BandDifferentialEntropy(apply_to_baseline=True),
                transforms.ToInterpolatedGrid(DEAP_CHANNEL_LOCATION_DICT, apply_to_baseline=True),
            ]),
        ...
        if class_type == 'binary':
            seed = SEEDBinaryDataset(
                io_path='../processed_data/seed_binary_de_interpolated_grid',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
            ...
            seed = SEEDDataset(
                io_path='../processed_data/seed_de_interpolated_grid',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
        ...
        dreamer = DREAMERDataset(
            io_path='../processed_data/dreamer_de_interpolated_grid',
            mat_path='../eeg_data/dreamer/DREAMER.mat',
        ...
        deap = DEAPDataset(
            io_path='../processed_data/deap_psd_grid',
            root_path='../eeg_data/deap/data_preprocessed_python',
        ...
        if class_type == 'binary':
            seed = SEEDBinaryDataset(
                io_path='../processed_data/seed_binary_psd_grid',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
            ...
            seed = SEEDDataset(
                io_path='../processed_data/seed_psd_grid',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
        ...
        dreamer = DREAMERDataset(
            io_path='../processed_data/dreamer_psd_grid',
            mat_path='../eeg_data/dreamer/DREAMER.mat',
        ...
        deap = DEAPDataset(
            io_path='../processed_data/deap_de_psd_grid',
            root_path='../eeg_data/deap/data_preprocessed_python',
        ...
        if class_type == 'binary':
            seed = SEEDBinaryDataset(
                io_path='../processed_data/seed_binary_de_psd_grid',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
            ...
            seed = SEEDDataset(
                io_path='../processed_data/seed_de_psd_grid',
                root_path='../eeg_data/seed/SEED_EEG/Preprocessed_EEG/',
        ...
        dreamer = DREAMERDataset(
            io_path='../processed_data/dreamer_de_psd_grid',
            mat_path='../eeg_data/dreamer/DREAMER.mat',
...
def prepare_dataloaders(
    ...
    for dataset_ in datasets:
        ...
        trainloader = DataLoader(CustomDataset(subset_train), batch_size=batch_size, num_workers=8)
        valloader = DataLoader(CustomDataset(subset_val), batch_size=batch_size, num_workers=8)
        testloader = DataLoader(CustomDataset(subset_test), batch_size=batch_size, num_workers=8)
...
def prepare_dataloaders_v1(
    ...
    for dataset_ in datasets:
        ...
        num_val = int(test_ratio * num_train_val)
        num_train = num_train_val - num_val

        for_train, for_val, for_test = random_split(
            dataset_, [num_train, num_val, num_test], torch.Generator().manual_seed(333)
        )
        '''

        train_ratio = round((1 - test_ratio) * (1 - test_ratio), 5)
        val_ratio = round((1 - test_ratio) * test_ratio, 5)
        test_ratio = 1 - train_ratio - val_ratio

        for_train, for_val, for_test = random_split(
            dataset_, [train_ratio, val_ratio, test_ratio], torch.Generator().manual_seed(333)
        )
        ...
        trainloaders.append(
            DataLoader(TernaryDataset(for_train), batch_size=batch_size, shuffle=True, num_workers=8)
        )
        valloaders.append(
            DataLoader(TernaryDataset(for_val), batch_size=batch_size, shuffle=False, num_workers=8)
        )
        testloaders.append(
            DataLoader(TernaryDataset(for_test), batch_size=batch_size, shuffle=False, num_workers=8)
        )
